...
func TestToTime(t *testing.T) {
	tests := []struct {
		...
		{
			"2018-10-21T23:21:29+0200",
			time.Date(2018, 10, 21, 21, 21, 29, 0, time.UTC),
			false,
		...
		{
			"11:00PM",
			time.Date(0, 1, 1, 23, 0, 0, 0, time.UTC),
			false,
		}, // Kitchen
		{
			"Nov 10 23:00:00",
			time.Date(0, 11, 10, 23, 0, 0, 0, time.UTC),
			false,
		}, // Stamp
		{
			"Nov 10 23:00:00.000",
		...
		{
			"Nov 10 23:00:00.000000",
			time.Date(0, 11, 10, 23, 0, 0, 0, time.UTC),
			false,
		}, // StampMicro
		{
			"Nov 10 23:00:00.000000000",
			time.Date(0, 11, 10, 23, 0, 0, 0, time.UTC),
			false,
		}, // StampNano
		{
			"2016-03-06 15:28:01-00:00",
			time.Date(2016, 3, 6, 15, 28, 1, 0, time.UTC),
			false,
		}, // RFC3339 without T
		{
			"2016-03-06 15:28:01-0000",
			time.Date(2016, 3, 6, 15, 28, 1, 0, time.UTC),
			false,
		...
		{
			time.Date(2009, 2, 13, 23, 31, 30, 0, time.UTC),
			time.Date(2009, 2, 13, 23, 31, 30, 0, time.UTC),
			false,
		},
		// errors
