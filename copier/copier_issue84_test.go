...
func TestIssue84(t *testing.T) {
	...
	t.Run("from issue", func(t *testing.T) {
		...
		copier.CopyWithOption(&destObj1, &workObj, reflectutils.Option{IgnoreEmpty: true, DeepCopy: false})

		copier.CopyWithOption(&destObj2, &notWorkObj, reflectutils.Option{IgnoreEmpty: true, DeepCopy: false})
	})
}
