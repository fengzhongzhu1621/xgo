...
func TestStructField(t *testing.T) {
	...
	optionsDeepCopy := reflectutils.Option{
		DeepCopy: true,
	}
...
func TestMapInterface(t *testing.T) {
	...
	t.Run("Should work with deepCopy", func(t *testing.T) {
		...
		to := DriverOptions{}
		if err := copier.CopyWithOption(&to, &from, reflectutils.Option{
			DeepCopy: true,
		}); nil != err {
			t.Errorf("Unexpected error: %v", err)
			return
	...
	t.Run("Test copy map with nil interface", func(t *testing.T) {
		...
		copier.CopyWithOption(&to, &from, reflectutils.Option{IgnoreEmpty: true, DeepCopy: true})
...
func TestAnonymousFields(t *testing.T) {
	t.Run("Should work with unexported ptr fields", func(t *testing.T) {
		...
		err := copier.CopyWithOption(&to, &from, reflectutils.Option{
			DeepCopy: true,
		})
		if err != nil {
			t.Errorf("Unexpected error: %v", err)
...
func TestCopyMapOfSliceValue(t *testing.T) {
	...
	for i := range ms {
		copier.CopyWithOption(&ms[i], s, reflectutils.Option{IgnoreEmpty: false, DeepCopy: true})
...
func TestCopyWithOption(t *testing.T) {
	...
	if err := copier.CopyWithOption(to, &from, reflectutils.Option{IgnoreEmpty: true}); err != nil {
		t.Error("Should not raise error")
	}
...
func TestDeepCopyInterface(t *testing.T) {
	...
	copier.CopyWithOption(&to, &from, reflectutils.Option{
		IgnoreEmpty: false,
		DeepCopy:    true,
	})
...
func TestDeepCopyTime(t *testing.T) {
	...
	err := copier.CopyWithOption(&to, from, reflectutils.Option{DeepCopy: true})
	if err != nil {
		t.Error("Should not raise error")
	}
...
func TestNestedPrivateData(t *testing.T) {
	...
	var deep hasMembers
	err = copier.CopyWithOption(&deep, &src, reflectutils.Option{DeepCopy: true})
	if err != nil {
